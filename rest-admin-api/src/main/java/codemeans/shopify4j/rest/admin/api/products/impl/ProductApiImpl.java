...
public class ProductApiImpl implements ProductApi {
  ...
  @Override
  public HttpResponse<ProductList> list(ListReq req) throws HttpResponseException {
  ...
  @Override
  public HttpResponse<Product> get(long id) throws HttpResponseException {
    return invoker.get(singleEndpoint(id), Product.class);
  }

  @Override
  public HttpResponse<Product> create(Product req) throws HttpResponseException {
    HttpRequest httpRequest = HttpRequest.of(resourcesEndpoint())
        .setBody(req);
  ...
  @Override
  public HttpResponse<Product> update(long id, Product req) throws HttpResponseException {
